						...
						<div class="flex flex-col md:flex-row md:justify-end md:items-center gap-0.5 md:gap-1">
											...
											<div class="mt-2 md:mt-0 flex flex-col">
												...
												>
													...
													<div class="grow">
														...
														<p
															class="mt-3 inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 group-hover:underline group-focus:underline font-medium dark:text-blue-400"
														>
															Learn more
															<svg
							...
							>
								<svg
									...
									stroke-linecap="round"
									stroke-linejoin="round"
									><path d="M12 12h.01" /><path d="M16 6V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2" /><path
					...
					{#if session !== null}
						<div class=" flex flex-wrap items-center gap-x-1.5">
							<a
								...
								href={`/${session.user.user_metadata.display_name}/dashboard`}
							>
								Dashboard
							</a>
						</div>
...
<style lang="postcss">
	...
	:global(html) {
		...
		--background-color-dark: theme(colors.gray.800);
